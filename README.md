...
2. [Corporate Procurement Tracker - Excel to Power BI](https://github.com/Muntasir18/Procurement-Analysis-Budget-Tracker)
*Developed during my previous professional role. I modernized a manual, multi-user procurement process into an automated **Power BI** dashboard. Features real-time budget tracking per funding source and vendor performance analysis.

3. [Uber Business Insights - Advanced SQL](https://github.com/Muntasir18/Relational-Database-Analysis-Uber-SQL)
